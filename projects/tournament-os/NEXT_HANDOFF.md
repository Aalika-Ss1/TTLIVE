...
- L2 Score Lifecycle is done. 
- L3 Stream/Public Safety is done.
- L4 Export is done. 
- L5 (Phase 2): Discord OAuth2 integration for Web Registration Profile is complete.
- L6 (Phase 2): Grouping & Seeding UI (Admin Auto-seed 16/32 players) is complete.
- L7 (Phase 2): Stream UI (OBS Transparent Overlay with animations) is complete.
- L8 (Phase 2): Score Submission (Evidence Upload UI) is complete.
...
1. Follow docs/POSTGRES_READINESS_CHECKLIST.md for production prep.
2. OCR Integration Pipeline (Reading uploaded score screenshots).
3. Advanced Discord Bot capabilities (Score reporting directly via bot).
## Do Not Build Yet
